...
if __name__ == '__main__':
    ...
    if params.method == 'baseline':
      ...
      if params.method in ['maml', 'maml_approx']:
        model = MAML(  model_dict[params.model], approx = (params.method == 'maml_approx'), test_mode = True , **few_shot_params )
    ...
    if params.method in ['maml', 'maml_approx', 'anil', 'annemaml', 'xmaml', 'tra_anil', 'aux_maml', 'alfa', 'reptile']: #maml do not support testing with feature
        ...
        novel_loader     = datamgr.get_data_loader( loadfile, aug = 'none', sn = params.sn, label_folder = '/content/drive/MyDrive/PhD/BreaKHis_40x_masked_labels')
